...
int main() {
    ...
    *(pp2+2)=&"mellon";
    ...
    //Note that **pp2 is a pointer to pointers so it only references the beginning of the sentence which is the character h
    printf("\n This is the beginning of the sentence: %c", **pp2);
